...
<table width="650" height="363" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#e4e4e4" class="a2">
    <tr>
      <td height="24" align="center" valign="middle" bgcolor="#FFFFFF" class="a1">图片<span class="style1">录入</span></td>
    </tr>
    <tr>
        ...
        <form name="add" method="POST" action="?work=addnews" >
          <div align="center">          
            <table width="100%" height="266" border="0" cellpadding="3" cellspacing="1" bgcolor="#e4e4e4" class="a2">
              <tr class="a3">
                <td width="11%" height="23" align="center">图片标题</td>
                <td height="23"><input type="text" name="title" size="50" >
      * &nbsp; </td>
              </tr>
              <input type="hidden" name="auth" size="50">
              <tr class="a3">
                <td width="11%" height="20" align="center">图片地址</td>
      ...
      *<br>
      <iframe border=0 frameborder=0 framespacing=0 height=22 width=300 marginheight=0 marginwidth=0 name=new_date noresize scrolling=no  src="upload.htm" vspale="0"></iframe></td>
              ...
              <tr class="a3">
                <td width="11%" height="25" align="center">图片类别</td>
                <td height="25"><%
...
%>
            ...
            %>
              ...
              <tr class="a3">
                <td width="11%" height="90" align="center">图片说明</td>
              ...
              <tr class="a3">
                ...
                <td height="29" colspan="2" align="center"><input type="submit" value="发表图片" name="submit">
&nbsp;
...
<table width="650" border="0" align="center" cellpadding="3" cellspacing="1" class="a2">
  <tr class="a1">
    <td width="571" height="20" align="center" valign="middle"><span class="tetle_top2">图片列表</span></td>
    <td width="79" align="center" valign="middle"><input type="button" name="Submit" value="添加图片" onClick="window.location='?work=addnews&cla=<%= cla %>';">
    </a></td>
  </tr>
  <tr>
    <td colspan="2">
...
<TR align="center" valign="middle">
	...
	<TD width="57%" class="a1">标题</TD>
	<TD width="18%" class="a1">日期</TD>
	<TD colspan="2" class="a1">相关操作</TD>
</TR>
<%
	set rs=server.createobject("adodb.recordset") 
	...
	if rs.eof then 
	Response.Write "暂无图片或没有找到类别<br><br>"
	else
...
<form name="form1" method="post" action="?cla=<%=cla%>">
  <span class="tebfont1">总共：<font color="#ff0000"><%=rs.PageCount%></font>页, <font color="#ff0000"><%=proCount%></font>个产品, 当前页：<font color="#ff0000"><%=intCurPage%> </font><%if intCurPage<>1 then
...
<table width="650" height="278" border="0" align="center" cellpadding="3" cellspacing="1" class="a2" >
      <tr>
        <td height="29" align="center" valign="middle" class="a1">图片编辑</td>
      </tr>
    <tr>
      <td width="100%" height="237">
              <table width="100%" height="267" border="0" align="center" cellpadding="3" cellspacing="1" class="a2">
				...
				<tr class="a3"> 
                  <td width="13%" height="31" align="center">图片标题</td>
                  <td height="31"> 
...
*&nbsp;</td>
                ...
                <tr class="a3"> 
                  <td width="13%" height="27" align="center">图片地址</td>
                  <td height="27"> 
                    <input type="text" name="come" size="50" value="<%=rs("come")%>">
                  *</td>
                </tr>
                <tr class="a3"> 
                <td width="13%" height="27" align="center">图片类别</td>
                <td height="27">
				<%
			...
			set rss=nothing%>
                ...
                <tr class="a3"> 
                  <td width="13%" height="90" align="center">图片说明</td>
                  <td height="90"> 
...
<table  width="500" border="0" align="center"  cellpadding="0" cellspacing="1" bgcolor="#E4E4E4" class="a2" style="font-family:宋体;font-size: 9pt;">
  <tr bgcolor="#F7F7F7" class="a1">
    <td height="22" colspan="5" align="center" valign="middle">图片管理 </td>
  </tr>
  <tr>
    ...
    <td bgcolor="#F7F7F7" align="center" valign="middle" colspan="3">相关操作</td>
  </tr>
  <%if rs.eof then%>
  <tr bgcolor="#FFFFFF">
...
%>
  <tr bgcolor="#FFFFFF">
    ...
    <td width="14%" align="center" valign="middle" bgcolor="#FFFFFF"><a href="?work=addcla&CLid=<%=rs("id")%>">添加小类</a></td>
  </tr>
  <%
set rs1=server.createobject("adodb.recordset") 
...
%>
  <tr align="left">
    <td colspan="5"><a href="?work=addcla&CLid=<%=rs("id")%>">添加小类</a></td>
  </tr>
  <%
End if
rs1.close
