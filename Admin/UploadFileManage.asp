...
Const MaxFileSize=20000        '上传文件大小限制
Const SaveUpFilesPath="UpImgFile/"        '存放上传文件的目录
Const UpFileType="gif|jpg|bmp|png|swf|doc|zip|rar"        '允许的上传文件类型
Const MaxPerPage=20
dim strFileName
...
<table width="700" border="0" cellpadding="3" cellspacing="1" class="a2">
 <tr class=a4>
    <td align="center" valign="top" class="a1"><strong>上 传 文 件 管 理</strong></td>
  </tr>
...
%>
      <table width="650" border="0" align="center" cellpadding="3" cellspacing="1" class="a2">
        <tr class="a1">
          <td width="235" height="25" align="center">文件名</td>
          <td width="85" height="20" align="center">文件大小</td>
          <td width="78" height="20" align="center">文件类型</td>
          <td width="157" height="20" align="center">最后修改时间</td>
          <td width="57" height="20" align="center">操作</td>
        </tr>
        <%
...
%>
        <tr bgcolor="#FFFFFF" class="tdbg">
          ...
          <td width="85" align="right"><%=theFile.size%>字节</td>
          <td width="78" align="center"><%=theFile.type%></td>
          <td width="157" align="center"><%=theFile.DateLastModified%></td>
          <td width="57" align="center"><a href="UploadFileManage.asp?Action=Del&FileName=<%=UploadDir&theFile.Name%>" onClick="return ConfirmDel()">删除</a></td>
        </tr>
        <%
		FileCount=FileCount+1
		TotleSize=TotleSize+theFile.Size
