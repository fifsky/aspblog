...
%>
                  <li><a href=media.asp?id=<%=rsa("id")%>><%=RSa("MidCls")%></a></li>
                <%
rsa.movenext
LOOP
rsa.close
...
%>
                    <td width="220" height=12 class="style4"><% = Left(rsnews("title"),18) %></td>
                    <td width="30"><script>playring('<%=rsnews("id")%>')</script></td>
                    <% 
...
%></td>
	...
	<tr>
		<td>
			<img src="img/fgf.gif" width="94" height="1" alt=""></td>
		<td>
			<img src="img/fgf.gif" width="23" height="1" alt=""></td>
		<td>
			<img src="img/fgf.gif" width="139" height="1" alt=""></td>
		<td>
			<img src="img/fgf.gif" width="123" height="1" alt=""></td>
		<td>
			<img src="img/fgf.gif" width="36" height="1" alt=""></td>
		<td>
			<img src="img/fgf.gif" width="32" height="1" alt=""></td>
		<td>
			<img src="img/fgf.gif" width="30" height="1" alt=""></td>
		<td>
			<img src="img/fgf.gif" width="16" height="1" alt=""></td>
		<td>
			<img src="img/fgf.gif" width="78" height="1" alt=""></td>
		<td>
			<img src="img/fgf.gif" width="163" height="1" alt=""></td>
		<td>
			<img src="img/fgf.gif" width="140" height="1" alt=""></td>
		<td>
			<img src="img/fgf.gif" width="18" height="1" alt=""></td>
		<td>
			<img src="img/fgf.gif" width="112" height="1" alt=""></td>
	</tr>
</table>
<map name="Map">
