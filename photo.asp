...
%>
	  ...
	  <td width="427" height="414" colspan="5" rowspan="2" valign="top" background="images/VTsj_17.jpg"><table width="100"  border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="668" height="228" valign="top" background="images/photo3.gif"><table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td><DIV class="site-menu1">
                    <%
set rsa=server.createobject("adodb.recordset") 
 sqla="select * from HN_procla where CLid=1 and MidCls<>'' order by id ASC" 
 rsa.open sqla,conn,1,1
DO WHILE Not rsa.eof
%>
                    <li><a href=photo.asp?id=<%=rsa("id")%>><%=RSa("MidCls")%></a></li>
                  <%
rsa.movenext
LOOP
rsa.close
...
%>
              ...
              <tr>
                <td height="200" valign="top"><table border="0" cellspacing="0" cellpadding="0">
                    <%
cid=request("id")
if cid="" then
...
%>
                    <tr>
                      ...
                      <td><table width="69" height="68"  border="0" cellpadding="0" cellspacing="0" align="center">
                          <tr>
                            <td><a title="<%=rsnews("demo")%>" href="<%=rsnews("come")%>" rel="lightbox[plants]"><img src="<%=rsnews("come")%>" width="49" height="49" border="0"></a></td>
                          </tr>
                      </table></td>
                      <%
rsnews.MoveNext 
...
%>
        ...
        <tr>
          <td width="668" height="81" background="images/photo4.gif"><table width="417" cellpadding="0" cellspacing="0" border="0">
            <tr>
